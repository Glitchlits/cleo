...
# Test hierarchy scoring functionality with text format
set -e
...
# Test with focused epic and text format
echo "Testing with focused epic T001 and text format..."
TODO_FILE=test_todo.json bash scripts/next.sh --explain --format text