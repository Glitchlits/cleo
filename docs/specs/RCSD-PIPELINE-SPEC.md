...
- Directory structure under `.claude/rcsd/`
...
ct research T500
       |
       | (produces .claude/rcsd/T500_[short-name]/_research.json)
       v
ct consensus T500
       |
...
3. Creates directory `.claude/rcsd/TXXX_[short-name]/`
...
```json
{
  ...
  "workflow": "rcsd",
  "associations": {
    "rcsdDirectory": ".claude/rcsd/T500_auth-system/",
    "specFile": null,
    "decomposedTasks": []
  }
}
...
**Location**: `.claude/rcsd/RCSD-INDEX.json`
  ...
  "workflows": [
    {
      "taskId": "T500",
      "shortName": "auth-system",
      "directory": ".claude/rcsd/T500_auth-system/",
      "state": "decomposed",
      "stages": {
        "research": {
...
**Location**: `.claude/rcsd/TXXX_[short-name]/_manifest.json`
...
```json
{
  "$schema": "https://claude-todo.dev/schemas/v1/rcsd-research.schema.json",
  "_meta": {
    "stage": "research",
    "version": "1.0.0",
    "timestamp": "2025-12-23T10:05:00Z",
...
```json
{
  "$schema": "https://claude-todo.dev/schemas/v1/rcsd-consensus.schema.json",
  "_meta": {
    "stage": "consensus",
    "version": "1.0.0",
...
**Last Updated**: 2025-12-23
**RCSD Source**: T500
**RCSD Directory**: .claude/rcsd/T500_auth-system/
...
- Task-anchored directory structure (`.claude/rcsd/TXXX_[short-name]/`)
